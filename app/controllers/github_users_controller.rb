class GithubUsersController < ApplicationController
  ...
  private
    ...
    def github_user_params
      params.require(:github_user).permit(:github_login, :github_id, :avatar_url, :url, :html_url, :type, :name, :company, :email, :public_repos, :github_created_at, :github_updated_at)
    end
end
